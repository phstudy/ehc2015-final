...
public class UserPreprocessingExtraTop20MarkReducer extends Reducer<Text, UserSession, NullWritable, Text> {
    ...
    protected void reduce(Text key, Iterable<UserSession> values,
        ...
        context.write(NullWritable.get(), new Text(bigUserSession.toTop20MarkString()));
