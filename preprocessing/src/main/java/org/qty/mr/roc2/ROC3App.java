...
public class ROC3App extends Configured implements Tool {
    ...
    protected Job buildJob(Configuration conf, String type) throws IOException {
        ...
        job.setJarByClass(ROC3App.class);
        job.setMapOutputKeyClass(Text.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);
        job.setReducerClass(OutputOrderedPidReducer.class);
